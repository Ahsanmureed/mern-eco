...
const ShoppingCart = () => {
  ...
  return (
    <div className="container mx-auto pt-[75px]">
      <h2 className="text-2xl font-bold text-center mt-4 mb-4">Shopping Cart</h2>
      {cart.length === 0 ? (
  ...
  {cart.map((item) => (
    <li key={item.id} className="flex flex-col sm:flex-row items-center sm:justify-between p-4 border rounded-lg shadow">
      {/* Product Image */}
      ...
      <div className="flex items-center mt-4 sm:mt-0">
        ...
        <span className="w-12 text-center border">{item.quantity}</span>
        <button
